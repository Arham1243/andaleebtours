...
@section('content')
    <div class="col-md-12">
        <div class="dashboard-content">
            ...
            <form action="{{ route('admin.orders.update', $order->id) }}" method="POST" id="validation-form">
                @csrf
                @method('PATCH')
                <div class="row">
                    <div class="col-md-9">
                                ...
                                <div class="form-box__body">
                                    ...
                                    <div class="form-check mt-2">
                                        <input class="form-check-input" type="radio" name="payment_status"
                                            ...
                                            {{ old('payment_status', $order->payment_status ?? '') == 'refunded' ? 'checked' : '' }}>
                                ...
                                <div class="form-box__body">
                                    ...
                                    <div class="form-check mt-2">
                                        <input class="form-check-input" type="radio" name="status" id="refunded"
                                            value="refunded"
                                            {{ old('status', $order->status ?? '') == 'refunded' ? 'checked' : '' }}>
