                                ...
                                <div class="form-box__body">
                                    <div class="form-fields">
                                        ...
                                        <input type="text" name="yalago_id" class="field"
                                            value="{{ old('yalago_id', $hotel->yalago_id) }}" data-required
                                    ...
                                    <div class="form-fields">
                                        ...
                                        <input type="text" name="name" class="field"
                                            value="{{ old('name', $hotel->name) }}" data-required data-error="Name">
                                        @error('name')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-fields">
                                        ...
                                        <select name="country_id" class="field select2-select" data-error="Country"
                                            ...
                                            @foreach ($countries as $c)
                                                <option value="{{ $c->id }}"
                                                    {{ old('country_id', $hotel->country_id) == $c->id ? 'selected' : '' }}>
                                                    {{ $c->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-fields">
                                        ...
                                        <select name="province_id" class="field select2-select" data-error="Province"
                                            ...
                                            @foreach ($provinces as $p)
                                                <option value="{{ $p->id }}"
                                                    {{ old('province_id', $hotel->province_id) == $p->id ? 'selected' : '' }}>
                                                    {{ $p->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-fields">
                                        ...
                                        <select name="location_id" class="field select2-select" data-error="Location"
                                            ...
                                            @foreach ($locations as $l)
                                                <option value="{{ $l->id }}"
                                                    {{ old('location_id', $hotel->location_id) == $l->id ? 'selected' : '' }}>
                                                    {{ $l->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-fields">
                                        ...
                                        <input type="number" name="rating" class="field"
                                            value="{{ old('rating', $hotel->rating) }}" step="0.1" min="0"
                                            max="5">
                                        @error('rating')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="form-fields">
                                        ...
                                        <textarea name="address" class="field">{{ old('address', $hotel->address) }}</textarea>
                                        @error('address')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-fields">
                                        ...
                                        <input type="text" name="geo_code_accuracy" class="field"
                                            value="{{ old('geo_code_accuracy', $hotel->geo_code_accuracy) }}">
                                    ...
                                    <div class="form-fields">
                                        ...
                                        <textarea rows="5" name="description" class="field">{{ old('description', $hotel->description) }}</textarea>
                                        @error('description')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-fields">
                                        ...
                                        <textarea rows="5" name="summary" class="field">{{ old('summary', $hotel->summary) }}</textarea>
                                        @error('summary')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-fields">
                                        ...
                                        <textarea rows="5" name="images" class="field">{{ old('images', $hotel->images) }}</textarea>
                                        @error('images')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-box__body">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="status" id="active"
                                            value="active"
                                            {{ old('status', $hotel->status) == 'active' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check mt-2">
                                        <input class="form-check-input" type="radio" name="status" id="inactive"
                                            value="inactive"
                                            {{ old('status', $hotel->status) == 'inactive' ? 'checked' : '' }}>
