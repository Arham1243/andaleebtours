...
<head>
    ...
    <title>Payment Success - #ANT-2026-8812</title>
    <style>
        @font-face {
            ...
            <table width="100%" cellpadding="0" cellspacing="0" class="border-bottom">
                <tr>
                    <td class="section-padding" align="left">
                        <p
                            style="font-size: 13px; color: #28a745; font-weight: bold; margin-bottom: 5px; text-transform: uppercase;">
                            Payment Confirmed</p>
                        <h1>Order #ANT-2026-8812 Fully Paid</h1>
                        <p style="font-size: 15px; color: #666666; line-height: 1.6; margin-bottom: 20px;">
                            The payment for this booking has been successfully captured. Please review the customer
                            details and finalize the vouchers.
                        </p>
            ...
            <div class="booking-card"
                ...
                <table width="100%" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        ...
                        <td align="right"><span class="status-badge">Paid</span>
                        </td>
                    </tr>
                </table>
