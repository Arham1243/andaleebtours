...
<head>
    ...
    <title>Payment Failed - {{ $insurance->insurance_number }}</title>
    <style>
        @font-face {
    ...
    <center class="wrapper">
        <div class="container">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" class="border-bottom">
                <tr>
                    <td class="section-padding" align="left">
                        ...
                        <h1>Payment Failed: {{ $insurance->insurance_number }}</h1>
                        <p style="font-size: 15px; color: #666666; line-height: 1.6; margin-bottom: 20px;">
                            Unfortunately, your payment for travel insurance could not be processed. Please try again to complete your purchase.
                        </p>
            ...
            <div class="reason-box">
                <p style="margin: 0 0 10px 0; font-size: 13px; color: #dc3545; font-weight: 700;">
                    Why did this happen?
                </p>
                <p style="margin: 0; font-size: 13px; color: #666666; line-height: 1.6;">
                    Payment failures can occur due to insufficient funds, incorrect card details, bank restrictions, or network issues. 
                ...
                <tr>
                    <td style="padding: 20px; background-color: #fafafa; border: 1px solid #eeeeee; border-radius: 4px;">
                        <table width="100%" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td style="padding: 8px 0; border-top: 2px solid #dc3545; padding-top: 15px; margin-top: 10px;">
                                    <span class="label">Amount to Pay</span><br>
                ...
                <tr>
                    <td align="center">
                        <a href="{{ route('user.travel-insurances.pay-again', $insurance->id) }}"
                            style="display: inline-block; background-color: #dc3545; color: #ffffff; padding: 12px 30px; text-decoration: none; font-size: 14px; font-weight: 600; border-radius: 4px;">
                            Retry Payment
                        </a>
                    </td>
                </tr>
            ...
            <p style="text-align: center; font-size: 13px; color: #666666; margin-top: 20px;">
                Need help? Contact us at <a href="mailto:info@andaleebtours.com" style="color: #111111; font-weight: 600;">info@andaleebtours.com</a>
            </p>
