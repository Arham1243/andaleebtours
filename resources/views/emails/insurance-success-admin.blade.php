...
<head>
    ...
    <title>New Insurance Sale - {{ $insurance->insurance_number }}</title>
    <style>
        @font-face {
            ...
            <table width="100%" cellpadding="0" cellspacing="0" class="border-bottom">
                <tr>
                    <td class="section-padding" align="left">
                        <h1>New Travel Insurance Sale</h1>
                        <p style="font-size: 15px; color: #666666; line-height: 1.6; margin-bottom: 20px;">
                            A new travel insurance policy has been successfully sold and confirmed.
                        </p>
                        <span class="status-badge">PAYMENT: PAID</span>
                        <span class="status-badge" style="border-color: #0066cc; background-color: #f0f8ff; color: #0066cc;">CONFIRMED</span>
                    </td>
                </tr>
            </table>
                ...
                <tr>
                    <td style="padding: 20px; background-color: #fafafa; border: 1px solid #eeeeee; border-radius: 4px;">
                        <table width="100%" cellpadding="0" cellspacing="0">
                            ...
                            @endif
                            <tr>
                                <td colspan="2" style="padding: 8px 0; border-top: 2px solid #28a745; padding-top: 15px; margin-top: 10px;">
                                    <span class="label">Total Premium Received</span><br>
