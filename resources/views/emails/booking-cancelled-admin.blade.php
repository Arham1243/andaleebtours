...
<body>
    <center class="wrapper">
        <div class="container">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" class="border-bottom">
                <tr>
                    <td class="section-padding" align="left">
                        <h1>Order Cancelled by User: {{ $order->order_number }}</h1>
                        <p style="font-size: 15px; color: #666666; line-height: 1.6; margin-bottom: 20px;">
                            A customer has cancelled their booking. The cancellation was processed on
            ...
            <table width="100%" cellpadding="0" cellspacing="0" class="border-bottom" style="padding: 20px 0;">
                <tr>
                    <td>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="margin-top: 30px;">
                <tr>
                    <td align="center">
                        <a href="{{ route('admin.orders.show', $order->id) }}" class="btn-view" target="_blank">
                            View Order Details
                        </a>
                    </td>
                </tr>
