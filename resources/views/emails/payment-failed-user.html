...
<body>
    <center class="wrapper">
        <div class="container">
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    <td class="section-padding" align="left">
                        <p style="font-size: 15px; color: #666666; margin-bottom: 10px;">Dear Alexander Thompson,</p>
                        ...
                        <p style="font-size: 15px; color: #666666; line-height: 1.6; margin-bottom: 0;">
                            We were unable to process your payment for the booking below. Your reservation is currently
                            on hold. Please attempt the payment again or use a different payment method to secure your
                            spot.
                        </p>
                    </td>
                </tr>
            ...
            <!-- Resolution Steps -->
            <table width="100%" cellpadding="0" cellspacing="0" style="padding-bottom: 30px; margin-bottom: 10px;"
                class="border-bottom">
                <tr>
                    <td align="left"
                        style="font-size: 14px; color: #111111; line-height: 1.6; padding: 20px; border: 1px solid #f4f4f4; background-color: #fcfcfc;">
                        <strong>What to do next:</strong><br />
                        1. Check that your card information and billing address are correct.<br />
                        2. Ensure your card has sufficient funds or check with your bank if they are blocking the
                        transaction.<br />
                        3. Contact our support
                        team if you require a new payment link or need immediate assistance.
                        <a href="mailto:support@andaleebtravels.com"
                            style="color: #dc3545; text-decoration: underline; font-weight: 600;">support@andaleebtravels.com</a>
                    </td>
                </tr>
            </table>
            ...
            <div class="booking-card"
                ...
                <table width="100%" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        ...
                        <td align="right"><span class="status-badge">Payment Failed</span>
                        </td>
                    </tr>
                </table>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="padding-bottom: 12px; border-bottom: 1px solid #f4f4f4;">Infant (1
                                        &times; <span class="dirham">D</span>250.00)</td>
                                    <td align="right"
                                        style="padding-bottom: 12px; border-bottom: 1px solid #f4f4f4; color: #111111;">
                                        <span class="dirham">D</span>250.00</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td align="right"
                                        ...
                                        <span class="dirham" style="font-size: 14px;">D</span>1,200.00
                                    </td>
                                </tr>
                            </table>
                        </td>
